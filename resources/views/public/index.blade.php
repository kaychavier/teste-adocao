      ...
      <div class="container h-100">
        <div class="d-flex flex-column align-items-start justify-content-center h-100 pb-4">
          ...
          <a
            ...
            class="btn btn-custom d-flex align-items-center gap-3 mt-4 px-4 text"
          >
            Buscar um PET
  ...
  <section class="bg-light py-5">
    <div class="container mb-4 d-flex flex-column align-items-center">
      ...
      <div class="row">
        <div class="col-4">
          <div
            class="d-flex align-items-center h-100 rounded overflow-hidden"
            style="background-color: #FFE8BA;"
          >
            <img
              src="img/cartoon-dog.webp"
              alt="Cachorro em desenho animado"
              width="130"
            >
        ...
        <div class="col-4">
          <div
            class="d-flex align-items-center h-100 rounded overflow-hidden"
            style="background-color: #DC9AFE;"
          >
            <img
              src="img/cartoon-cat.webp"
              alt="Gato em desenho animado"
              width="130"
            >
            <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
              E não há recompensa maior do que vê-los se tornando aquela coisinha alegre e saudável depois de uma boa dose
        ...
        <div class="col-4">
          <div
            class="d-flex align-items-center h-100 rounded overflow-hidden"
            style="background-color: #84FBFF;"
          >
            <img
              src="img/cartoon-cat-2.webp"
              alt="Gato em desenho animado"
              width="130"
            >
            <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
