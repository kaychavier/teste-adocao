...
@section('content')
    ...
    <div class="bg-custom rounded overflow-hidden">
      ...
      <table class="table mb-0 table-custom table-dark align-middle">
        ...
        <tbody>
              ...
              <td>
                <div class="d-flex justify-content-center">
                  <button
                    ...
                    onclick="showDetails({{ $animal->load(['specie', 'breed']) }})"
                  >
                    <svg
                  ...
                  <a
                    href="{{ route('panel.animal.edit', $animal) }}"
                    class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2"
                    title="Editar"
                  >
                    <svg
                  ...
                  <form
                    action="{{ route('panel.animal.destroy', $animal) }}"
                    method="POST"
          ...
          @empty
            <tr>
              <td colspan="3">Nenhum animal encontrado!</td>
            </tr>
          @endforelse
        </tbody>
      </table>
      ...
      <div class="modal-content bg-custom">
        ...
        <div class="modal-body d-flex flex-wrap row-gap-4">
          ...
          <div class="col-6">
            ...
            <div id="animal-age"></div>
          </div>

          <div class="col-6">
            <div><small>Peso:</small></div>
            <div id="animal-weight"></div>
          </div>

          <div class="col-6">
            <div><small>Porte:</small></div>
            <div id="animal-size"></div>

          </div>

          <div class="col-6">
            <div><small>Gênero:</small></div>
            <div id="animal-genre"></div>

          </div>

          <div class="col-6">
            <div><small>Espécie:</small></div>
            <div id="animal-specie"></div>

          </div>

          <div class="col-6">
            <div><small>Raça:</small></div>
            <div id="animal-breed"></div>

          </div>

          <div class="col-6">
            <div><small>Local:</small></div>
            <div id="animal-address"></div>
          </div>
  ...
  <script>
    function showDetails(data) {
      document.getElementById('animal-name').innerHTML = data.name;
      document.getElementById('animal-age').innerHTML = data.age;
      document.getElementById('animal-weight').innerHTML = data.weight + 'kg';
      document.getElementById('animal-size').innerHTML = data.size;
      document.getElementById('animal-genre').innerHTML = data.genre;
      document.getElementById('animal-specie').innerHTML = data.specie.name;
      document.getElementById('animal-breed').innerHTML = data.breed.name;
      document.getElementById('animal-address').innerHTML = data.address;
